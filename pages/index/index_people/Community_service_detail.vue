	...
	<view class="bg-white">
		<view class="box top bg-white">
			<view class="cu-bar bg-white search solid-bottom" style="border-top: #DDDDDD 1upx solid;">
				<view class="action" @tap="goMore('/pages/index/index_people/Community_service')">
		...
		<view class="bg-white">
			<view class="text-black" style="background-color: #e9e9e9; margin: 15upx 30upx; padding: 10upx;border-radius: 10upx; font-size: 27upx;line-height: 37upx;">
				<text style="background-color: #ff1b31;color: #FFFFFF; margin-right: 10upx;padding: 6upx; border-radius: 5upx; font-size: 23upx; ">店家介绍</text>            
				源丰好五金店...
			</view>
		</view>
		<view class="bg-white text-black solid-left solid-right" style="margin: 20upx 30upx;text-indent: 40upx; font-size: 27upx; line-height: 39upx;">
			<view class="solid-top solid-bottom flex align-center">
				<view class="bg-gray solid-right text-right  padding-tb-sm" style="margin: 0; width: 200upx;">电话号码：</view>
				<view>123456789</view>
			</view>
			...
			<view class="solid-bottom flex align-center">
				<view class="bg-gray solid-right text-right  padding-tb-sm" style="margin: 0; width: 200upx;">地点：</view>
				<view>上江北</view>
			</view>
			<view class="solid-bottom flex align-center">
