<template>
	<view>
		...
		<scroll-view scroll-x class="bg-white nav navfirst" scroll-with-animation :scroll-left="scrollLeft">
			<view class="cu-item navfirst_1" :class="index==TabCur?'bg-red cur':'bg-orange'" v-for="(item,index) in List1" :key="index" @tap="gotoUrl(item)" :data-id="index">
			    {{item.name}}
			</view>
		</scroll-view>
		<scroll-view scroll-x class="bg-gray nav navsecond padding-left solid-bottom" scroll-with-animation :scroll-left="scrollLeft">
			<view class="cu-item" :class="index==Tab?'text-red cur':''" v-for="(item,index) in List2" :key="index" @tap="gotoUrl(item)" :data-id="index">
			    {{item.name}}
			</view>
		</scroll-view>
		...
		<view class="cu-list menu-avatar">
			<view class="flex bg-white justify-between" style="padding: 10upx; border-bottom: #DDDDDD 1upx solid;">
				<view class="flex" @tap="goMore('/pages/index/index_people/Three_affairs_detail')">
					<view>
			...
			<view class="bg-white" style="padding-bottom: 10upx; border-bottom: #DDDDDD 1upx solid;">
				<view class="content"  @tap="goMore('/pages/index/index_people/Three_affairs_detail')">
					...
					<view class="">
						<view class="flex" style="padding: 0 10upx;">
							...
							<image src="../../../static/input/图层11_1.png" mode="" style="width: 190upx; height: 160upx; padding-left: 10upx;"></image>
						</view>
					</view>
					<view class="margin-top-sm flex justify-between">
						<view class="text-gray text-xs" style="padding-left: 10upx;">2019-12-23 19:00</view>
						<view class="action text-gray" style="padding-right: 15upx;">
	...
	export default {
		data() {
			return {
				...
				List2: [{
					name: '党务公开',
					url:'/pages/index/index_people/Party_affairs'
				}, 
				{
					name: ' / 居务公开',
					url:'/pages/index/index_people/Village_affairs'
				}, 
				{
					name: ' / 财务公开',
					url:'/pages/index/index_people/Financial_disclosure'
				}],
