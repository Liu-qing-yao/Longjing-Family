	...
	<view>
		...
		<view class="cu-list menu-avatar solid-top">
			<view class="flex bg-white justify-between" style="padding: 10upx; border-bottom: #DDDDDD 1upx solid;">
				<view class="flex" @tap="goMore('/pages/index/index_people/Community_service_detail')">
					<view>
						<image src="../../../static/input/图层1319@3x.png" mode="" style="width: 180upx; height: 160upx;"></image>
					</view>
					<view class="" style="margin-left: 10upx;">
						<view class="text-black text-xs" style="width: 640upx;">源丰好五金店</view>
			...
			<view class="flex bg-white justify-between" style="padding: 10upx; border-bottom: #DDDDDD 1upx solid;">
				<view class="flex" @tap="goMore('/pages/index/index_people/Community_service_detail')">
					<view>
						<image src="../../../static/input/图层1319.png" mode="" style="width: 180upx; height: 160upx;"></image>
					</view>
					<view class="" style="margin-left: 10upx;">
						<view class="text-black text-xs" style="width: 640upx;">手机维修店</view>
						<view class="text-gray text-sm flex justify-between" style="padding-top: 90upx;">
							<view class="text-cut text-xs" >
								2019-12-22  16:00
							</view> 
			...
			<view class="flex bg-white justify-between" style="padding: 10upx; border-bottom: #DDDDDD 1upx solid;">
				<view class="flex" @tap="goMore('/pages/index/index_people/Community_service_detail')">
					<view>
						<image src="../../../static/input/图层13119.png" mode="" style="width: 180upx; height: 160upx;"></image>
					</view>
					<view class="" style="margin-left: 10upx;">
						<view class="text-black text-xs" style="width: 640upx;">速派星五金水电维修</view>
						<view class="text-gray text-sm flex justify-between" style="padding-top: 90upx;">
							<view class="text-cut text-xs" >
								2019-12-22  16:00
							</view> 
