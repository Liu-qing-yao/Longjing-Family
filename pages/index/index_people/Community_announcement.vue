	...
	<view>
		...
		<view class="cu-list menu-avatar solid-top">
			<view class="flex bg-white justify-between" style="padding: 10upx; border-bottom: #DDDDDD 1upx solid;">
				<view class="flex"  @tap="goMore('/pages/index/index_people/anuounce-detail')">
					<view>
						<image src="../../../static/input/图层860拷贝.png" mode="" style="width: 180upx; height: 160upx;"></image>
					</view>
			...
			<view class="bg-white" style="padding-bottom: 10upx; border-bottom: #DDDDDD 1upx solid;">
				<view class="content"  @tap="goMore('/pages/index/index_people/anuounce-detail')">
					...
					<view class="">
						<view class="flex" style="padding: 0 10upx;">
							<image src="../../../static/input/图层860拷贝.png" mode="" style="width: 190upx; height: 160upx; padding-right: 10upx;"></image>
