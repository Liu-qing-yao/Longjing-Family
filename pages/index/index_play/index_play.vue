<template>
	<view id="moments">
		...
		<view class="moments__post margin-lr" style="border: none;" v-for="(post,index) in posts" :key="index" :id="'post-'+index">
			<view class="post_right solid" style="border-radius: 25upx; padding: 30upx 20upx; margin: 0 0;">
				<view class="flex justify-star">
					<view class="post-left">
						<image class="post_header" src="../../../static/input/person.png"></image>
					</view>
					<view class="padding-left" >
						<view style="font-size: 28upx;">李四</view>
						<view style="padding-top: 15upx; font-size: 24upx;">2019-12-12 22：00</view>
					</view>
				</view>
				<view style="font-size: 28upx;">今天进行了法制教育，很有收获哦！</view>
				<!-- 相册 -->
...
<script>
	...
	export default {
		...
		onNavigationBarButtonTap(e) {//监听标题栏点击事件
			if (e.index == 0) {
				this.navigateTo('../index_story/index_story')
			}
		},
		computed:{
