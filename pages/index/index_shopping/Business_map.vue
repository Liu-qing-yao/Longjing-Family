					...
					<view>
						<view class=''>
							<view class='header bg-ff row padding flex justify-between'>
								<!-- <view class="solid radius flex justify-start text-left" style="padding: 0;height: 60upx;">
								   {{address.address}}<input class="text-left" style="padding: 0; margin: 0; height: 60upx; text-indent: 15upx;" focus />
							    </view> -->
								<input class="uni-input"  style="text-indent: 15upx;" focus />
