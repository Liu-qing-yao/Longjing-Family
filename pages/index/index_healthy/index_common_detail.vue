	...
	<view class="bg-white">
		<view class="box top bg-white">
			<view class="cu-bar bg-white search solid-bottom" style="border-top: #DDDDDD 1upx solid;">
				<view class="action" @tap="goMore('/pages/index/index_healthy/index_common')">
		...
		<view class="bg-white text-black" style="margin: 15upx 30upx;text-indent: 40upx; font-size: 27upx; line-height: 39upx;">
			 <view class="text-center">
				 <image src="../../../static/input/图层8.png" mode="" style="height: 320upx;width: 510upx;"></image>
			 </view>
			  <text> 颈椎病容易被高血压掩盖，患者往往更关注高血压，但事实上，骨质刺激交感神经，导致颈椎病引起血压升高或降低。而且，与单纯的高血压病人不同，有的颈椎病患者还常常伴有颈部疼痛、上肢麻木等现象。
			  </text> 
		</view>
