	...
	<view>
		<view class="box top">
			<view class="cu-bar bg-gray">
				<view class="action">
					<text class="cuIcon-close"></text>设置-关于龙井人家
				</view>
		...
		<view class="padding flex justify-center">
			<image class="" src="../../../static/input/形状4@3x.png" mode="" style="width: 210upx; height: 200upx;"></image>
		</view>
		<view class="text-center">四川省自贡市龙井街道办事处</view>
		
		 <view class="foot" style="position: absolute; bottom: 140upx;left: 320upx;">
			版权信息
		</view>
