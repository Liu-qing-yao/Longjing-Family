	...
	<view class="bg-white">
		<view class="box top bg-white">
			<view class="cu-bar bg-white search solid-bottom" style="border-top: #DDDDDD 1upx solid;">
				<view class="action" @tap="goMore('/pages/index/Personal-center/Participation1')">
		...
		<view class="bg-white">
			<view class="" style="margin: 10upx 20upx 0; padding-bottom: 5upx;">
				<view>
					
					<view class="flex justify-left" style="padding: 5upx 0;font-size: 31upx;">					
						<view class="face" >
							<image src="../../../static/input/头像圆.png" mode="" style="width: 100upx; height: 100upx;"></image>
						</view>
						<view class="padding-left">
							<view class="" style="font-size: 29upx;margin-top: 5upx;">
							   <view class="">李明明</view>
							</view>
							<view class="margin-top-sm flex justify-between align-center" style="font-size: 25upx;">
								<view class=" text-df" style="font-size: 25upx;">2019-12-12 16:00</view>
								<view class="action" style="margin-left: 100upx;">
						...
						<view class="bg-white">
							...
							<view class="bg-white"  style="margin: 0 30upx; font-size: 27upx;padding: 0;" @tap.stop="" :style="[{top:CustomBar+'px',height:'calc(20vh - ' + CustomBar + 'px)'}]">
								...
								<!-- <view class="margin-lr">
									<view style="padding: 10upx 0 0;">
										<text style="color: #7ba8e5;">{{ item.description6}}</text>
										<text style="font-size: 25upx;">{{ item.description7}}</text>
									</view>
									<view style="padding: 10upx 0 0;">
										<text style="color: #7ba8e5;">{{ item.description8}}</text>
										<text style="font-size: 25upx;">{{ item.description10}}</text>
