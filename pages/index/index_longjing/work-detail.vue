	...
	<view class="bg-white">
		<view class="box top bg-white">
			<view class="cu-bar bg-white search solid-bottom" style="border-top: #DDDDDD 1upx solid;">
				<view class="action" @tap="goMore('/pages/index/index_longjing/Work_dynamics')">
		...
		<view class="bg-white text-black" style="margin: 15upx 30upx;text-indent: 40upx; font-size: 27upx; line-height: 39upx;">
			 <view class="align-center">
				 <image src="../../../static/input/图片.png" mode="" style="height: 350upx;width: 610upx;"></image>
			 </view>
			  <text>疫情发生以来，大安区农业农村局按照各级疫情防控要求，迅速行动，周密安排，主动应对，切实抓好蔬菜、水果、畜禽产品、水产品等农产品质量安全工作，确保广大人民群众农产品消费安全。
			  </text> 
		</view>
