	...
	<view class="bg-white">
		<view class="box top bg-white">
			<view class="cu-bar bg-white search solid-bottom" style="border-top: #DDDDDD 1upx solid;">
				<view class="action" @tap="goMore('/pages/index/index_longjing/Community style')">
					...
					<uni-popup class="pup-windows " ref="showpopup" :type="type" @change="change">
						<view class="popup-content">
							...
							<view class="" @tap="showModal" data-target="Modal">
								<uni-fav :checked="checkList[3]" class="" style="" fg-color="#f06e72" fg-color-checked="#f06e72" bg-color-checked="none" bg-color="none" @click="favClick(3)" />
							</view>
						</view>
					</uni-popup>
				</view>
		...
		<view class="bg-white text-black" style="margin: 15upx 30upx;text-indent: 40upx; font-size: 27upx; line-height: 39upx;">
			 <view class="align-center">
				 <image src="../../../static/input/图片.png" mode="" style="height: 380upx;width: 610upx;"></image>
			 </view>
			  <text> 在自贡东北部的青龙湖畔隐匿着一座上百年的深宅大院——李庄。李庄位于大山铺镇伍家堰，始建于清朝道光年间的1848年，光绪初年因为自贡有名的盐绅李敬才接收入住这里，故名“李庄”。
			  </text> 
		</view>
