<template style="background-color: #FFFFFF;">
	<view class="bg-white">
			...
			<view class="" style="margin: 0 20upx ; padding-bottom: 10upx;">
				<view class="content">
					<view class="text-gray text-center" style="padding: 15upx 0;font-size: 31upx;">					
						<view class="text-center text-black">习近平主持中央政治局专题民主生活会并发表指示</view>
					</view>
		...
		<view class="bg-white text-black" @tap="goMore('/pages/index/index_longjing/extranet')" style="margin: 15upx 30upx;text-indent: 40upx; font-size: 27upx; line-height: 39upx;">
			  <text>中共中央政治局于12月26日至27日召开“不忘初心、牢记使命”专题民主生活会。会议认真学习贯彻党的十九届四中全会精神，紧扣学习贯彻习近平新时代中国特色社会主义思想这一主线，聚焦“不忘初心、牢记使命”这一主题，贯彻“守初心、担使命，找差距、抓落实”的总要求，围绕理论学习有收获、思想政治受洗礼、干事创业敢担当、为民服务解难题、清正廉洁作表率的目标，按照“四个对照”、“四个找一找”的要求，交流思想、检视问题、深刻剖析，开展批评和自我批评。
			  </text> 
		</view>
